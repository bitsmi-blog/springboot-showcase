package com.bitsmi.springbootshowcase.sampleapps.web.common.mapper;

import com.bitsmi.springbootshowcase.sampleapps.domain.common.dto.Sort.Direction;
import com.bitsmi.springbootshowcase.sampleapps.web.common.controller.request.PaginatedRequest;
import com.bitsmi.springbootshowcase.sampleapps.web.common.controller.response.Pagination;
import com.bitsmi.springbootshowcase.sampleapps.web.common.controller.response.Sort;
...
public interface IPaginationMapper
{
    ...
    @Mapping(target = "sort", defaultExpression = "java(com.bitsmi.springbootshowcase.sampleapps.web.common.controller.response.Sort.UNSORTED)")

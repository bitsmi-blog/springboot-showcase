...
import com.bitsmi.springbootshowcase.sampleapps.application.testsupport.common.ApplicationCommonTestFixture;
...
public class ApplicationModuleMockConfig
{
    ...
    public UserSummaryApplicationQueryMocker userSummaryApplicationQueryMocker(
            ...
            @Autowired(required = false) ApplicationCommonTestFixture applicationCommonTestFixture
    ) {
